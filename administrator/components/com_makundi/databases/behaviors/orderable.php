 ...
 */
class ComMakundiDatabaseBehaviorOrderable extends KDatabaseBehaviorAbstract
{
    ...
    protected function _afterTableInsert(KCommandContext $context)
    {
        ...
        $orders = $this->getService('com://admin/makundi.model.category_orderings')
    ...
    {
        $this->getService('com://admin/makundi.model.category_orderings')
        ->id($context->data->id)
        ->getItem()
        ->delete();
    }
